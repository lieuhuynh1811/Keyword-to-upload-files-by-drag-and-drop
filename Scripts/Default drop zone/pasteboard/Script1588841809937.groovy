...
WebUI.uploadFileWithDragAndDrop(findTestObject('Object Repository/pasterboard/inputCap'), filePath)

WebUI.verifyElementPresent(findTestObject('pasterboard/btnDelete'), 0)
